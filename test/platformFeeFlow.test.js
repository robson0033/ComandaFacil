...
test("Pix usa somente o valor planejado e preserva a taxa da parte online", () => {
  ...
  assert.match(controller, /buildPlatformFeeSnapshot\(valorPix\)/);
  ...
  assert.doesNotMatch(controller, /transaction_amount:\s*valorPix\s*\+/);
});
